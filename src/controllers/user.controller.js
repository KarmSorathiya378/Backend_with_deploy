...
const generateAccessAndRefreshToken = async(userid) => {
    try {
        ...
        console.log("error during generation of access and refresh tokens" )
...
const registerUser = asyncHandler( async(req, res) => {
    ...
    // validation checks
    // ckeck if user already exists: username , email
...
const loginUser = asyncHandler( async (req, res) => {
    // get data from login (user input)
    // validate the data ( email / password)
    // find the user in db
